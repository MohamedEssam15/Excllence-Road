...
@section('title')
    @lang('translation.activeTeachers')
@endsection
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-md-6">
                            ...
                            <p class="card-title-desc">@lang('translation.activeTeachers')</p>
                        </div>
                        ...
                        <table class="table table-centered table-nowrap mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">@lang('translation.coursesNumber')</th>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" id="blockTeacherButton"
    ...
    <script>
        $(document).ready(function() {
            window.fetchData = function(query = '', page = 1) {
                $.ajax({
                    url: baseUrl + "/users/teachers/active?page=" +
    ...
    <script>
        $(document).ready(function() {
            ...
            blockModal.addEventListener('show.bs.modal', function(event) {
                ...
                var modalTeacherId = document.getElementById('teacher-id');
            ...
            $('#blockTeacherButton').click(function() {
                var form = $('#blockTeacherForm');
                var formData = form.serialize(); // Serialize form data

                $.ajax({
                    type: 'POST',
                    url: baseUrl + '/users/teachers/block', // Change this to your actual route
                    data: formData,
