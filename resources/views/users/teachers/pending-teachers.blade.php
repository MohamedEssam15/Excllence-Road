...
@section('title')
    @lang('translation.pendingTeachers')
@endsection
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-md-6">
                            ...
                            <p class="card-title-desc">@lang('translation.pendingTeachers')</p>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            window.fetchData = function(query = '', page = 1) {
                $.ajax({
                    url: baseUrl + "/users/teachers/pending?page=" +
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#acceptTeacherButton').click(function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: baseUrl + '/users/teachers/accept', // Change this to your actual route
                    data: formData,
