...
@section('title')
    @lang('translation.blockedTeachers')
@endsection
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-md-6">
                            ...
                            <p class="card-title-desc">@lang('translation.blockedTeachers')</p>
                        </div>
...
@section('script')
    <script>
        $(document).ready(function() {
            window.fetchData = function(query = '', page = 1) {
                $.ajax({
                    url: baseUrl + "/users/teachers/blocked?page=" +
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#acceptTeacherButton').click(function() {
                var form = $('#acceptTeacherForm');
                var formData = form.serialize(); // Serialize form data

                $.ajax({
                    type: 'POST',
                    url: baseUrl + '/users/teachers/reactive', // Change this to your actual route
                    data: formData,
