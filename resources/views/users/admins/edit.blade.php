                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            @role('admin')
                                <p class="card-title-desc">@lang('translation.editAdmin')</p>
                            @endrole
                        </div>
                    ...
                    <div class="mt-4">
                        <form action="{{ route('users.admin.update', $admin->id) }}" class="outer-repeater" method="POST"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control" id="formrow-name-input"
                                            value="{{ $admin->name }}" style="text-align: start;direction: ltr">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" name="email" class="form-control" id="formrow-email-input"
                                            value="{{ $admin->email }}" style="text-align: start;direction: ltr">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <input class="form-control form-control-lg" id="formFileLg" name="profileImage"
                                    type="file">
                                <small>@lang('translation.currentImage'): <img src="{{ $admin->getAvatarPath() }}" alt="Current Image"
                                        width="100"></small>
                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" class="form-check-input"
                                                    id="accept-reject-courses" value="accept-reject-courses"
                                                    onchange="updatePermissions(this, 'courses')" date-category="courses">
                                                <label class="form-check-label"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" class="form-check-input" id="rejected-courses"
                                                    value="rejected-courses" onchange="updatePermissions(this, 'courses')"
                                                    date-category="courses">
                                                <label class="form-check-label"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" class="form-check-input" id="active-packages"
                                                    value="active-packages" onchange="updatePermissions(this, 'packages')"
                                                    date-category="packages">
                                                <label class="form-check-label"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" class="form-check-input" id="edit-category"
                                                    value="edit-category" onchange="updatePermissions(this, 'categories')"
                                                    date-category="categories">
                                                <label class="form-check-label"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" class="form-check-input"
                                                    ...
                                                    onchange="updatePermissions(this, 'users')" date-category="users">
                                                <label class="form-check-label"
...
@section('script')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const adminPermissions = {!! json_encode($adminPermissions) !!};
            // Check if 'courses' permission exists and trigger the function
            if (adminPermissions.includes('courses')) {
                const checkbox = document.getElementById('categorySwitch-courses');
                if (checkbox) {
                    checkbox.checked = true;
                    togglePermissionsDiv('courses', checkbox);
                }
            }
            if (adminPermissions.includes('packages')) {
                const checkbox = document.getElementById('categorySwitch-packages');
                if (checkbox) {
                    checkbox.checked = true;
                    togglePermissionsDiv('packages', checkbox);
                }
            }
            if (adminPermissions.includes('categories')) {
                const checkbox = document.getElementById('categorySwitch-categories');
                if (checkbox) {
                    checkbox.checked = true;
                    togglePermissionsDiv('categories', checkbox);
                }
            }
            if (adminPermissions.includes('feature-content')) {
                const checkbox = document.getElementById('categorySwitch-feature-content');
                if (checkbox) {
                    checkbox.checked = true;
                    togglePermissionsDiv('feature-content', checkbox);
                }
            }
            if (adminPermissions.includes('users')) {
                const checkbox = document.getElementById('categorySwitch-users');
                if (checkbox) {
                    checkbox.checked = true;
                    togglePermissionsDiv('users', checkbox);
                }
            }
            if (adminPermissions.includes('transactions')) {
                const checkbox = document.getElementById('categorySwitch-transactions');
                if (checkbox) {
                    checkbox.checked = true;
                    togglePermissionsDiv('transactions', checkbox);
                }
            }
            adminPermissions.forEach(element => {
                ...
                if (checkbox) {
                    checkbox.checked = true;
                    var category = checkbox.getAttribute('date-category');
                    updatePermissions(checkbox, category);
                }
            });
        });
