...
@section('title')
    @lang('translation.currentCommission')
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <h4 class="card-title">@lang('translation.teachers')</h4>
                            <p class="card-title-desc">@lang('translation.currentCommission')</p>
                        </div>
                        ...
                        <table class="table table-centered table-nowrap mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">@lang('translation.soldCoursesCount')</th>
                                    <th scope="col">@lang('translation.currentMonthRevenue')</th>
                                    <th scope="col">@lang('translation.totalRevenueTillNow')</th>
    ...
    <script>
        $(document).ready(function() {
            window.fetchData = function(query = '', page = 1) {
                $.ajax({
                    url: baseUrl + "/transactions/teachers/revenue?page=" +
