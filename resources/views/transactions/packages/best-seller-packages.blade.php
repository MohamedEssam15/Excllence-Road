...
@section('title')
    @lang('translation.bestSellerPackages')
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <h4 class="card-title">@lang('translation.bestSellerPackages')</h4>
                            <p class="card-title-desc">@lang('translation.bestSellerPackagesInfo')</p>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            window.fetchData = function(query = '', page = 1) {
                $.ajax({
                    url: baseUrl + "/transactions/packages/best-seller?page=" +
