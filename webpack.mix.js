...
var app_live_assets = {
    js: [
        folder.src + "js/used/accept-modal.init.js",
        folder.src + "js/used/modify-modal.init.js",
        folder.src + "js/used/cancel-modal.init.js",
        folder.src + "js/used/back-to-pending-modal.init.js",
    ]
};

var liveout = folder.dist_assets + "js/";
lodash(app_live_assets).forEach(function (assets, type) {
    for (let i = 0; i < assets.length; ++i) {
        mix.js(assets[i], liveout + "used");
    };
});
